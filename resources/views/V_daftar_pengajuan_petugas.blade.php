...
@section('title', 'Daftar Pengajuan - SIPBAR Petugas')
...
<div class="relative z-10">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8 animate-fadeInUp">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <div class="flex items-center space-x-2">
                    ...
                    <h1 class="text-2xl md:text-3xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">Daftar Pengajuan</h1>
                </div>
                <p class="text-gray-500 text-sm mt-1 ml-3">Pengajuan peminjaman yang menunggu persetujuan</p>
            </div>
        </div>
        <div class="bg-gradient-to-r from-yellow-500 to-orange-500 text-white px-4 py-2 rounded-xl text-sm font-semibold shadow-md flex items-center space-x-2">
            ...
            <span>{{ $pengajuan->count() ?? 0 }} Pengajuan Menunggu</span>
        </div>
    </div>
    ...
    <div class="space-y-4" id="pengajuanContainer">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <div class="flex items-center space-x-2 mb-1 flex-wrap gap-2">
                                ...
                                <span class="bg-gradient-to-r from-yellow-500 to-orange-500 text-white text-xs px-2 py-0.5 rounded-full">Menunggu</span>
                            </div>
                            ...
                            <p class="text-xs text-gray-400 mt-1">Diajukan: {{ \Carbon\Carbon::parse($item->tgl_pengajuan)->translatedFormat('d F Y, H:i') }}</p>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden animate-scaleIn">
            <div class="p-12 text-center">
                ...
                <p class="text-gray-500 max-w-md mx-auto">Belum ada pengajuan peminjaman yang menunggu persetujuan. Semua pengajuan sudah diproses.</p>
            </div>
        </div>
        @endforelse
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full animate-modalPop overflow-hidden">
        ...
        <div class="p-6">
            <div class="text-center mb-4">
                ...
                <p class="text-xs text-gray-400 mt-2">Mahasiswa akan mendapatkan notifikasi dan dapat segera mengambil barang.</p>
            </div>
            <form id="approveForm" method="POST" class="flex justify-end space-x-3">
                @csrf
                @method('PUT')
...
<script>
    ...
    function openRejectModal(id) {
        rejectForm.action = `/petugas/pengajuan/${id}/tolak`;
    ...
    function openApproveModal(id) {
        approveForm.action = `/petugas/pengajuan/${id}/setujui`;
