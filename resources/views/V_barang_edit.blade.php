...
@section('title', 'Edit Barang - SIPBAR Admin')
    ...
    <div class="flex items-center space-x-4 mb-8 animate-fadeInUp">
        ...
        <div>
            <div class="flex items-center space-x-2">
                ...
                <h1 class="text-2xl md:text-3xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">Edit Barang</h1>
            </div>
            <p class="text-gray-500 text-sm mt-1 ml-3">Edit data inventaris barang</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-2xl overflow-hidden animate-scaleIn">
        ...
        <div class="bg-gradient-to-r from-gray-50 via-white to-gray-50 px-6 py-5 border-b border-gray-100">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h3 class="font-bold text-xl text-gray-800">Form Edit Barang</h3>
                    <p class="text-sm text-gray-500 mt-0.5">Edit data barang: <span class="font-semibold text-emerald-600">{{ $barang->nama_barang }}</span></p>
                </div>
            </div>
        </div>

        <!-- Form Body -->
        <form action="{{ route('barang.update', $barang->id) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="animate-slideInRight" style="animation-delay: 0.15s">
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <label class="relative flex cursor-pointer">
                            <input type="radio" name="kondisi" value="baik" class="peer sr-only" {{ old('kondisi', $barang->kondisi) == 'baik' ? 'checked' : '' }}>
                        ...
                        <label class="relative flex cursor-pointer">
                            <input type="radio" name="kondisi" value="rusak_ringan" class="peer sr-only" {{ old('kondisi', $barang->kondisi) == 'rusak_ringan' ? 'checked' : '' }}>
                        ...
                        <label class="relative flex cursor-pointer">
                            <input type="radio" name="kondisi" value="rusak_berat" class="peer sr-only" {{ old('kondisi', $barang->kondisi) == 'rusak_berat' ? 'checked' : '' }}>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="animate-slideInRight" style="animation-delay: 0.2s">
                    ...
                    <input type="number" name="stok_tersedia" value="{{ old('stok_tersedia', $barang->stok_tersedia) }}" required min="0"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="animate-slideInRight" style="animation-delay: 0.25s">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="denda_per_hari" value="{{ old('denda_per_hari', $barang->denda_per_hari) }}" required min="0"
            ...
            <div class="animate-fadeInUp" style="animation-delay: 0.3s">
                ...
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-emerald-500 transition-all duration-300">
                    <div class="space-y-2 text-center">
                        <div class="w-20 h-20 mx-auto bg-gradient-to-r from-emerald-100 to-teal-100 rounded-full flex items-center justify-center">
                        ...
                        <div id="imagePreview" class="mt-3">
                            <img src="{{ asset($barang->foto) }}" class="w-32 h-32 object-cover rounded-xl shadow-lg mx-auto">
                            <button type="button" onclick="removeImage()" class="mt-2 text-xs text-red-500 hover:text-red-700">Hapus Foto</button>
                        </div>
                        @else
            ...
            <div class="animate-fadeInUp" style="animation-delay: 0.35s">
                ...
                <textarea name="deskripsi" rows="4"
                    ...
                    placeholder="Deskripsikan barang ini...">{{ old('deskripsi', $barang->deskripsi) }}</textarea>
                @error('deskripsi')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
