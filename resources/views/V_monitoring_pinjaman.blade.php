...
<div class="relative z-10">
    ...
    <div class="space-y-4" id="pengajuanContainer">
        ...
        @php
            ...
            $hariTerlambat = $isTerlambat ? floor($tglKembali->diffInDays(now())) : 0;
        @endphp
    ...
    fetch(`/petugas/pengajuan/${id}/detail`)
        ...
        .then(data => {
            if (data.success) {
                ...
                detailContent.innerHTML = '<div class="text-center py-8 text-red-500">Gagal memuat data: ' + (data.message || 'Unknown error') + '</div>';
            }
        })
        .catch(error => {
            console.error('Error:', error);
            detailContent.innerHTML = '<div class="text-center py-8 text-red-500">Terjadi kesalahan: ' + error.message + '</div>';
        });
}
